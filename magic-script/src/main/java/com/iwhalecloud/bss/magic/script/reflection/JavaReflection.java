package com.iwhalecloud.bss.magic.script.reflection;

import com.iwhalecloud.bss.magic.script.convert.*;
import com.iwhalecloud.bss.magic.script.functions.*;
import com.iwhalecloud.bss.magic.script.functions.linq.AggregationFunctions;
import com.iwhalecloud.bss.magic.script.functions.linq.LinqFunctions;
import com.iwhalecloud.bss.magic.script.functions.linq.MathFunctions;
...
public class JavaReflection {
	...
	public static void registerFunction(Object target) {
		Stream.of(target.getClass().getMethods())
				.filter(method -> method.getAnnotation(com.iwhalecloud.bss.magic.script.annotation.Function.class) != null)
