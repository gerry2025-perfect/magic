package com.iwhalecloud.bss.magic.script.parsing;

import com.iwhalecloud.bss.magic.script.MagicScriptError;
import com.iwhalecloud.bss.magic.script.parsing.ast.*;
import com.iwhalecloud.bss.magic.script.parsing.ast.linq.*;
import com.iwhalecloud.bss.magic.script.parsing.ast.literal.*;
import com.iwhalecloud.bss.magic.script.parsing.ast.statement.*;
import com.iwhalecloud.bss.magic.script.parsing.ast.binary.AssigmentOperation;

import java.util.*;

import static com.iwhalecloud.bss.magic.script.parsing.TokenType.*;
