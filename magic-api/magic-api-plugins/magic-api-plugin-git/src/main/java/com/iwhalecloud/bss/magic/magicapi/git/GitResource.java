...
import com.iwhalecloud.bss.magic.magicapi.core.resource.FileResource;
...
public class GitResource extends FileResource {
	...
	public static GitResource of(com.iwhalecloud.bss.magic.magicapi.core.config.Resource config, MagicGitProperties properties) throws IOException, GitAPIException {
